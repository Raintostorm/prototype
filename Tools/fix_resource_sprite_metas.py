#!/usr/bin/env python3
"""Generate + fix sprite metas for Resources/UI/Meta/Resource."""
import re
import struct
import uuid
...
RESOURCE = ROOT / "Assets/SpinSquad/Resources/UI/Meta/Resource"
...
def main():
    if not RESOURCE.is_dir():
        print("No Resource folder — run sync_bar_resource_from_root.sh first.")
        return
    n = 0
    ...
    print(f"Done. Updated {n} resource sprite metas.")
